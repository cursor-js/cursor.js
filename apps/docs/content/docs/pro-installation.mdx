...
If you want to use `GeminiTTSPlugin` for hosted voice generation, add a Gemini TTS subscription to your Pro license. Review the available Solo and Team options in the [Gemini TTS add-on section](/pro#gemini-tts-add-on).
